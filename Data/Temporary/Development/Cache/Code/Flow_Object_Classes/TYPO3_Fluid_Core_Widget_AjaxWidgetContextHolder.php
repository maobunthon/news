...
class AjaxWidgetContextHolder extends AjaxWidgetContextHolder_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionProperty->isStatic() || $reflectionService->isPropertyAnnotatedWith('TYPO3\Fluid\Core\Widget\AjaxWidgetContextHolder', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
