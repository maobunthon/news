 ...
 * @api
 */
abstract class AbstractBackend_Original implements \TYPO3\Flow\Persistence\Generic\Backend\BackendInterface {
 ...
 * An abstract storage backend for the Flow persistence
 */
abstract class AbstractBackend extends AbstractBackend_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	 ...
	 protected function emitRemovedObject($object) {
		...
		$result = parent::emitRemovedObject($object);
			...
			try {
				...
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Persistence\Generic\Backend\AbstractBackend', 'emitRemovedObject', $methodArguments);
				$result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
				$methodArguments = $joinPoint->getMethodArguments();

				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitRemovedObject']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'])) {
					$advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitRemovedObject']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'];
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Persistence\Generic\Backend\AbstractBackend', 'emitRemovedObject', $methodArguments, NULL, $result);
	 ...
	 protected function emitPersistedObject($object, $objectState) {
		...
		$result = parent::emitPersistedObject($object, $objectState);
			...
			try {
				...
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Persistence\Generic\Backend\AbstractBackend', 'emitPersistedObject', $methodArguments);
				$result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
				$methodArguments = $joinPoint->getMethodArguments();

				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitPersistedObject']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'])) {
					$advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitPersistedObject']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'];
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Persistence\Generic\Backend\AbstractBackend', 'emitPersistedObject', $methodArguments, NULL, $result);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
