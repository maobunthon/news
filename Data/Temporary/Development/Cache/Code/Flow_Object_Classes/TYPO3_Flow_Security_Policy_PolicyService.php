 ...
 */
class PolicyService_Original implements \TYPO3\Flow\Aop\Pointcut\PointcutFilterInterface {
...
class PolicyService extends PolicyService_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (get_class($this) === 'TYPO3\Flow\Security\Policy\PolicyService') {
	 ...
	 */
	 private function Flow_Proxy_injectProperties() {
		...
		$this->injectPolicyExpressionParser(\TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('TYPO3\Flow\Security\Policy\PolicyExpressionParser'));
