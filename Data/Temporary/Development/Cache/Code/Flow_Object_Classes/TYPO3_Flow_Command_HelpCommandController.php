...
class HelpCommandController extends HelpCommandController_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	 ...
	 */
	 private function Flow_Proxy_injectProperties() {
		...
		$commandManager_reference = &$this->commandManager;
		$this->commandManager = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getInstance('TYPO3\Flow\Cli\CommandManager');
		if ($this->commandManager === NULL) {
			$this->commandManager = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getLazyDependencyByHash('6998e6ff7715cfe74761cf0f2ffc0799', $commandManager_reference);
			if ($this->commandManager === NULL) {
				$this->commandManager = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->createLazyDependency('6998e6ff7715cfe74761cf0f2ffc0799',  $commandManager_reference, 'TYPO3\Flow\Cli\CommandManager', function() { return \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('TYPO3\Flow\Cli\CommandManager'); });
			}
		}
