...
class FlowAnnotationDriver extends FlowAnnotationDriver_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionProperty->isStatic() || $reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Persistence\Doctrine\Mapping\Driver\FlowAnnotationDriver', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
