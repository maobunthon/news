...
class FlowQuery extends FlowQuery_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionProperty->isStatic() || $reflectionService->isPropertyAnnotatedWith('TYPO3\Eel\FlowQuery\FlowQuery', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
