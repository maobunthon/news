...
class Escape extends Escape_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionProperty->isStatic() || $reflectionService->isPropertyAnnotatedWith('TYPO3\Fluid\Core\Parser\Interceptor\Escape', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
