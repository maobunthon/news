...
class ObjectPathMappingRepository extends ObjectPathMappingRepository_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionProperty->isStatic() || $reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Mvc\Routing\ObjectPathMappingRepository', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
