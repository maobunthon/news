...
class TemplateView extends TemplateView_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionProperty->isStatic() || $reflectionService->isPropertyAnnotatedWith('TYPO3\Fluid\View\TemplateView', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
