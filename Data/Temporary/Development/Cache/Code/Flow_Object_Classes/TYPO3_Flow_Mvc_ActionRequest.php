	 ...
	 protected function emitRequestDispatched($request) {
		...
		$result = parent::emitRequestDispatched($request);
			...
			try {
				...
				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitRequestDispatched']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'])) {
					...
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Mvc\ActionRequest', 'emitRequestDispatched', $methodArguments, NULL, $result);
