...
class Typo3OrgSsoToken extends Typo3OrgSsoToken_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionProperty->isStatic() || $reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Security\Authentication\Token\Typo3OrgSsoToken', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
