 ...
 *
 */
class ElectronicAddressValidator_Original extends \TYPO3\Flow\Validation\Validator\GenericObjectValidator {
 ...
 * An electronic address validator
 */
class ElectronicAddressValidator extends ElectronicAddressValidator_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if ('TYPO3\Party\Domain\Validator\ElectronicAddressValidator' === get_class($this)) {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionProperty->isStatic() || $reflectionService->isPropertyAnnotatedWith('TYPO3\Party\Domain\Validator\ElectronicAddressValidator', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('TYPO3\Party\Domain\Validator\ElectronicAddressValidator', $propertyName, 'var');
	 ...
	 */
	 private function Flow_Proxy_injectProperties() {
		$this->injectValidatorResolver(\TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('TYPO3\Flow\Validation\ValidatorResolver'));
