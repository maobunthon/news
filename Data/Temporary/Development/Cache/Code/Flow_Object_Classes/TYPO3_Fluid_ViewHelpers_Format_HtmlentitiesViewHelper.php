 ...
 * @api
 */
class HtmlentitiesViewHelper_Original extends AbstractViewHelper implements CompilableInterface {
 ...
 * Applies htmlentities() escaping to a value
 */
class HtmlentitiesViewHelper extends HtmlentitiesViewHelper_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if ('TYPO3\Fluid\ViewHelpers\Format\HtmlentitiesViewHelper' === get_class($this)) {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionProperty->isStatic() || $reflectionService->isPropertyAnnotatedWith('TYPO3\Fluid\ViewHelpers\Format\HtmlentitiesViewHelper', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('TYPO3\Fluid\ViewHelpers\Format\HtmlentitiesViewHelper', $propertyName, 'var');
